...
namespace Bank.Data.Migrations
{
    ...
    [Migration("20230910161730_InitialCreate8")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bank.Entity.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bank.Entity.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bank.Entity.Concrete.CustomerAccount", b =>
                {
                    b.HasOne("Bank.Entity.AppUser", "AppUser")
            ...
            modelBuilder.Entity("Bank.Entity.Concrete.CustomerAccountTransictions", b =>
                {
                    b.HasOne("Bank.Entity.Concrete.CustomerAccount", "ReceiverCustomer")
                        .WithMany("CustomerReceiver")
                        .HasForeignKey("ReceiverId");

                    b.HasOne("Bank.Entity.Concrete.CustomerAccount", "SenderCustomer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Bank.Entity.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Bank.Entity.AppUser", null)
                        .WithMany()
